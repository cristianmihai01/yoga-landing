  ...
  return (
    <section className='bg-cardsBg min-h-[260px] pb-[55px] lg:-mt-24'>
      <div className='container mx-auto flex flex-col lg:flex-row gap-x-[32px]'>
        ...
        <div className='flex-1 flex gap-x-[15px] lg:gap-x-[32px] -mt-[38px] lg:-mt-[77px] z-10'>
          ...
          <div className='bg-white w-full max-w-[282px] p-[14px] lg:p-[26px] shadow-2xl rounded-md max-h-[282px]'>
            <div className='flex items-center mb-[18px] lg:mb-[28px]'>
              <h4 className='text-sm leading-4 lg:text-2xl lg:leading-7 font-bold text-heading mr-8'>
        ...
        {/* card 3 */}
        <div className='bg-white w-full max-w-[542px] p-[14px] lg:p-[26px] -mt-[38px] lg:-mt-[77px] z-10 shadow-2xl rounded-md flex justify-between items-start'>
